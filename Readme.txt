...
Github URL: https://github.com/loganathr/LinuxMint19hub/

Goto Home folder ( All config files need to be present in $HOME folder idealy).

$ cd $HOME

$ git clone https://github.com/loganathr/LinuxMint19hub/ .
...
LinuxMint19hub -- Utilities for Linux Mint 19 cinnamon maintained by loganathr
